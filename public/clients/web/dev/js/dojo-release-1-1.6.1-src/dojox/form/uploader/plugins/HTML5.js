...
dojo.getObject("dojox.form", true);

//hack because sometimes the function in the uploader comes after this is loaded
if (!dojox.form.addUploaderPlugin){
  console.debug("PLUGIN ERROR");
  dojox.form.addUploaderPlugin = function(){};
}
