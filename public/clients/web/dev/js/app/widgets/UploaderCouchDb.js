...
dojo.declare("app.widgets.UploaderCouchDb", [], {
	//
	// Version: 1.6
	//
	// summary:
	...
	upload: function(/*Object ? */formData){
		...
		//
		console.log("upload couchdb");
		this.onBegin(this.getFileList());
		
		//NOTE: only supporting modern browsers at the moment
...
return app.widgets.UploaderCouchDb;
});
