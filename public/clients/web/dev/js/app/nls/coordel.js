	...
	"root": {
	  ...
	  deadlineCalendar: "Deadline Calendar",
		...
		empty: {
		  ...
		  contactText: "This Person has no Tasks in any of your Coords",
		...
		"taskFormTip": {
		  ...
		  "nameText": "<p>You can add Tasks at any time by pressing the new task button in the header.</p><br/><p>Click the Blueprint button to start from Task you've Blueprinted.</p>",
		  ...
		  "deadlineTitle": "Set a Deadline",
		  "deadlineText": "Deadlines help track when Tasks need to be completed but aren't required. If the Task is part of a Coord and doesn't have a Deadline, the Coord's Deadline will be used",
		  "projectTitle": "Add Task to a Coord",
		  "projectText": "Coords let you coordinate your work with others",
		  "delegateTitle": "Delegate to Someone",
		  "delegateText": "You can delegate a Task to anyone. This removes the Task from your Current list. If you don't add it to a Coord, find it in your Delegated list",
