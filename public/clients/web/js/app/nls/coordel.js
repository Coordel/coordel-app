define({
	"root": {
	  ...
	  "noName": "No Name",
		...
		"projectInvite": "Coord Invitation",
	  ...
	  "info": "Info",
		...
		"task-blueprints": "Task Blueprints",
		"task-blueprint": "Task Blueprint",
		"project-blueprints": "Coord Blueprints",
		"project-blueprint": "Coord Blueprint",
		"shared-blueprints": "Shared Blueprints",
		"shared-blueprint": "Shared Blueprint",
		...
		"searchTaskBlueprints": "Search Task Blueprints",
		"searchProjectBlueprints": "Search Project Blueprints",
		"searchSharedBlueprints": "Search Shared Blueprints",
		"select": "Select",
		"message": "Message",
		"newTask": "New Task",
	  ...
	  changes: {
		...
		empty: {
		  ...
		  contactTitle: "No Visible Tasks",
		  contactText: "Follow tasks for this Person in Coords in which you are both participants",
		  ...
		  "task-blueprintsTitle": "No Task Blueprints",
		  "task-blueprintsText": "Track your Task Blueprints here",
		  "project-blueprintsTitle": "No Project Blueprints",
		  "project-blueprintsText": "Track your Project Blueprints here",
		...
		"blueprintDetails": {
		  "add": "Add from Blueprint",
		  "blueprintTask": "Blueprint Task", 
		  "blueprintProject": "Blueprint Coord",
		  "share": "Share Blueprint",
		  "shared": "Shared Blueprint",
		  "copy": "Copy Blueprint",
		  "copied": "Copied Blueprint",
		  "delete": "Delete Blueprint",
		  "showInfo": "Show Blueprint Info",
		  "selectContact": "Select Person",
		  "contactInstructions": "Start typing or press down arrow to select the person you want to receive this Blueprint"
		},
		"taskDetails": {
		  "name": "Task Name",
		  "editTask": "Edit Task",
