define(['dojo',
  ...
  var app = {
    ...
    showApp: function() {
      ...
      dojo.addClass(dojo.byId("loading"), "hidden");
      ...
      //resp.results.map(function(r){
        ...
        switch (chg.docType){
          ...
          case "project":
            ...
            if (chg.creator === app.username && chg.created === chg.updated && chg.origin && chg.origin !== "coordel-productivity"){
              console.log("change outside origin", chg);
