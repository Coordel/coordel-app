	...
	"root": {
	  ...
	  deadlineCalendar: "Deadline Calendar",
		...
		turbo: {
		  ...
		  "no": "No",
		  "transferText": "Transfer its attachments to another Project or Task",
		  "transferLabel": "Transfer",
		  "transferConfirmInstruct1": "Select Project or Project and Task to receive files",
		...
		projectActions: {
		  ...
		  markDone: "Mark Done",
		  confirmText: {
		    participate: "Click Participate to agree to do Tasks in this Project",
		    leave: "This will permanently remove your access to this Project and set all of your Current Tasks in the Project Unassigned",
		    follow: "Click Follow to gain access to this Project",
		    unfollow: "Click Unfollow to remove your access to this Project",
		    cancel: "This will permanently Cancel the Project. All Tasks and Roles in the Project will also be Cancelled",
		    pause: "This will pause all Tasks in the Project",
		    resume: "This will resume all Paused Tasks in the Project",
		    send: "This will activate the Project and send Pending Tasks to the assigned People",
	      deleteProject: "This will permanently delete this Project",
	      decline: "This will remove access from the Project",
	      reuse: "Click to save this project as a Template for reuse in the future",
	      clear: "Clear from list",
	      proposeChange: "This will alert the Project Responsible that you have made changes to the Role",
	      agreeChange: "",
	      markDone: "This will mark the Project Done. It will cancel any undone Tasks"
		  },
		  instructions: {
		    leave: "Enter why you are leaving the Project",
		    unfollow: "Enter why you won't be following the Project any longer",
		    cancel: "Enter why you are cancelling the Project",
		    pause: "Enter why you are pausing the Project",
		    resume: "Enter why you are resuming the Project",
		    decline: "Enter why you are declining the Project"
		  }
		},
		"taskActions": {
		  "header": "Actions",
		  ...
		  "participateProject": "Participate in Project",
		  ...
		  confirmText: {
		    "submit": "This will Submit this Task to the Delegator or Project Responsible for Approval",
		    ...
		    "raiseIssue": "This will send the Task to the Delegator or Project Responsible to Clear the Issue",
		...
		empty: {
		  ...
		  privateText: "Keep track of Tasks only you care about. All new Tasks go here unless they are added to a Project",
		  projectTasksTitle: "No Project Tasks",
		  projectTasksText: "Track all Tasks for this Project here",
		  ...
		  contactText: "This Contact has no Tasks in any of your Projects",
		...
		projectFormTip: {
		  nameTitle: "Add Projects here",
		  nameText: "<p>You can add Projects at any time by pressing Add icon in the footer</p><br/><p>Click the Reuse button to start a Project from a Template.</p>",
		  purposeTitle: "Give the Purpose of the Project",
		  purposeText: "Purpose tells what the Project will accomplish.",
		  deadlineTitle: "Set a Deadline",
		  deadlineText: "<p>Deadline indicate when the Project must be completed. When Tasks are added, if they don't have a Deadline, the Project Deadline will be used.</p><p>Deadlines default to one week from now if left blank.</p>",
		  responsibleTitle: "Choose the Person who is responsible for this Project.",
		  responsibleText: "The Responsible has full authority to get the Project done.",
		  peopleTitle: "Add People to the Project",
		  peopleText: "Every Person in the Project has access to the Stream and can have a Role in the Project",
		  rolesTitle: "Add Roles to the Project",
		  rolesText: "Each Role in the Project is assigned to one Person and has at least one Task.",
		  deferTitle: "Define work on the Project until a later date",
		  deferText: "Defer a Project if you aren't ready to start working on it yet. This removes all Tasks from everyone's Current list until the Defer Date",
			attachmentsTitle: "Add an Attachment",
		  attachmentsText: "An Attachment is someone People in the Project need to get their Tasks done. It might be a Template, a report, or some other file"
		},
		"taskFormTip": {
		  ...
		  "deadlineTitle": "Set a Deadline",
		  "deadlineText": "Deadlines help track when Tasks need to be completed but aren't required. If the Task is part of a Project and doesn't have a Deadline, the Project's Deadline will be used",
		  "projectTitle": "Add Task to a Project",
		  "projectText": "Projects let you coordinate your work with others",
		  "delegateTitle": "Delegate to Someone",
		  "delegateText": "You can delegate a Task to anyone. This removes the Task from your Current list. If you don't add it to a Project, find it in your Delegated list",
		...
		taskFormInstructions: {
		  ...
		  projectText: "<em>Purpose</em> - describe what you want to accomplish with this Project<br><em>Deadline</em> - the Deadline is required and defaults to three days from now."
		},
		"taskFormSelect": {
		  "projectNoneFound": "No Project Found",
		  "projectAdd": "Add Project...",
		  "delegateNoneFound": "No Contact Found",
		  "delegateAdd": "Invite Contact...",
		  "deliverablesNoneFound": "No Deliverable Found",
		  "deliverablesAdd": "",
		  "blockersNoneFound": "No Project Found",
		  "blockersAdd": "",
		  responsibleNoneFound: "No Contact Found",
		  responsibleAdd: "Invite Contact...",
		  peopleNoneFound: "No Contact Found",
		  peopleAdd: "Invite Contact..."
		},
		"taskFormAttachments": {
		...
		"stream": {
		  "showProject": "Navigate to Project",
		  "showTask": "Navigate to Task",
		  "showContact": "Navigate to Contact",
		...
		projDetails: {
		  ...
		  chooseAction: "Choose Project Action",
		  reuseProject: "Reuse Project",
		  showInfo: "Show Project Information",
		  hidePeopleRoles: "Hide People and Roles",
		  showPeopleRoles: "Show People and Roles",
		  instructions: {
		    quickEnterTask: "Click to quick-enter Project Tasks..."
		  }
		},
		"deliverable": {
